...
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y, SDL_RendererFlip flip_type)
{
	bool ret = true;
	SDL_Rect rect;
	...
	if(SDL_RenderCopyEx(renderer, texture, section, &rect, angle, p, flip_type) != 0)
	{
